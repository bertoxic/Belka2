...
class _ActivitiesPageState extends State<ActivitiesPage> {
  ...
  Widget build(BuildContext context) {
    return SafeArea( top: true,
      child: Scaffold( floatingActionButton: FloatingActionButton(onPressed: () {  },backgroundColor: kPrimary,child: Icon(Icons.add),),
        body: Stack(children: [
          Positioned(
              child: Container(
                color: kPrimary,
          ...
          Positioned( top: 50, left: 140,
              child: Container( height: 60,
                ...
                child: Row( mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    BigText(" Activities",color: Colors.grey.shade100,),
                  ],),
              )),
                              ...
                              children: [
                                Expanded(
                                  child: Column( crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      BigText("Mentorship Program with the team",size: 18,),
                                      SizedBox( width: 400,
                                          child: Smalltext("You have an appointment with your mentor our appointment with your mentor our mentor",)),
                                      Smalltext("10:30 - 11:45",color: Colors.black,),
